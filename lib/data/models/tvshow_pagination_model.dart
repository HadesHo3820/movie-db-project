...
class TvShowPaginationModel extends MoviePaginationEntity
    implements InterfaceModel {
  TvShowPaginationModel._internal();
  static final TvShowPaginationModel _singleton =
      TvShowPaginationModel._internal();
  factory TvShowPaginationModel.getInstance() => _singleton;

  TvShowPaginationModel.fromJson(Map<String, dynamic> json) {
    page = json['page'];
