...
class MovieList extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return SizedBox(
      height: HomeScreenDimens.movieListHeight,
...
Widget buildListItem(
  ...
  return InkWell(
    ...
    child: Container(
      height: HomeScreenDimens.movieItemHeight,
      width: HomeScreenDimens.movieItemWidth,
      ...
      child: Container(
        width: double.infinity,
        height: HomeScreenDimens.movieTitleItemHeight,
